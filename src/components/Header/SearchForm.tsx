          ...
          <div className="relative w-full max-w-[560px]">
            ...
            {searchModalOpen ? null : (
              <input
                type="text"
                placeholder="Search"
                className="w-full rounded-lg border border-stroke bg-gray-2 py-3 pl-13.5 pr-5 text-dark focus:border-primary focus:outline-none dark:border-none dark:bg-dark-2 dark:text-white dark:focus:border-primary xl:w-[560px]"
              />
            )}
          </div>
        </form>
