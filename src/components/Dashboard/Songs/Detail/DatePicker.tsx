...
type DatePickerProps = {
  initialDate?: Date | string; // Accept a Date object or string in ISO format
  onDateChange?: (date: Date | null) => void; // Callback for date change
};
    ...
    if (datePickerRef.current) {
      const fp = flatpickr(datePickerRef.current, {
        ...
        onChange: (selectedDates) => {
          if (onDateChange) {
            onDateChange(selectedDates[0] || null); // Call the callback with the selected date
          }
        },
      });
